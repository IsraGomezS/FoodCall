        ...
        do {
            ...
            switch(opcion){
                ...
                case 5://IMPRIMIR BASE DE DATOS PLATILLOS
                    for (int i = 0; i < 30; i++) {
                        //DECLARAR OBJETO PLATILLO
                        System.out.println(elMenu.getMenu().get(i));
                    }
                    
                    break;

                case 6://IMPRIMIR BASE DE DATOS VENTAS
                    int tamanio=pedido.getVentasConcretadas().size();
                    for (int i = 0; i < tamanio; i++) {
                        System.out.println(pedido.getVentasConcretadas().get(i));
                    }
