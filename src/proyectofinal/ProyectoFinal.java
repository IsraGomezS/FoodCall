...
public class ProyectoFinal {
    ...
    public static void moduloPedidos(int banderaMenu, Menu menu,Pedido ventas){
        ...
        //ESCOGER PLATILLO
        System.out.println("Ingrese el ID del platillo que desea ordenar:");
        do {
            opcionID=Integer.parseInt(entrada.next());
        ...
        do {
            opcionCantidad=Integer.parseInt(entrada.next());
        } while (opcionCantidad>menu.getMenu().get(opcionID).getExistencias());
        ...
        System.out.println("¿Desea confirmar su orden?");
