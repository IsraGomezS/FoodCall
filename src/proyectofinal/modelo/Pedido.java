...
public class Pedido {
     ...
     */
    public void moduloGeneradorPedidos(ArrayList <Platillo> menu, ArrayList <Pedido> ventas ){
        String catalogo=null;
        int indicePedidoAuxiliar=0,numero=0;
        int existencias=0;
        int cantidadAuxiliar=0;
        BaseDeDatos para100 =new BaseDeDatos();
        for (int i = 0; i < 100; i++) {
            ...
            do {
                ...
                cantidadAuxiliar=crearNumRandom(2,10);
            ...
            ventas.add(pedidoAuxiliar);
            //System.out.println(pedidoAuxiliar);
           catalogo+=pedidoAuxiliar.imprimirPedido(menu, pedidoAuxiliar,0);
           //numero=ventas.indexOf(pedidoAuxiliar);
           para100.creearTicket(ventas.indexOf(pedidoAuxiliar), pedidoAuxiliar.imprimirPedido(menu, pedidoAuxiliar,0));
        }
     ...
     */
    public String imprimirPedido(ArrayList <Platillo> menu, Pedido pedido, int idTicket){
        String ticke=null;
        if (idTicket==0){
            System.out.println("\n------Producto------");
            ticke="\n------Producto------";
        ...
        ticke+="\nPlatillo: "+menu.get(pedido.numPlatillo).getNombre();
        System.out.println("Precio: "+menu.get(pedido.numPlatillo).getPrecio()+" MXN");
        ticke+="\nPrecio: "+menu.get(pedido.numPlatillo).getPrecio()+" MXN";
        System.out.println("Descripcion: "+menu.get(pedido.numPlatillo).getDescripcion());
        ticke+="\nDescripcion: "+menu.get(pedido.numPlatillo).getDescripcion();
        ...
        ticke+="\nIncluye cubiertos desechables: "+cubiertos;
        ...
        ticke+="\nTotal: "+(pedido.cantidad)*menu.get(pedido.numPlatillo).getPrecio()+" MXN\n";
        return ticke;
    }
