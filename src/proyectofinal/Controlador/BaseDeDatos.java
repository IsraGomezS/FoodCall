...
public class BaseDeDatos {
    ...
    public void agregarBaseDeDatosCompletaPedidos(Pedido pedidos){ 
        
        for (int i = 0; i < pedidos.getVentasConcretadas().size(); i++) {
            agregar(pedidos.getVentasConcretadas().get(i));
        }
    }
    /**
    ...
    /**
     * Método que crea el respectivo archivo de cada ticket de compra.
     * @param idOrden Índice de una venta contenida en un ArrayList que guarda las ventas.
     * @param ticket Cadena que se imprime en al archivo.
     */
